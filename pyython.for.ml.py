...
fig = plt.figure()
ax3d = fig.add_subplot(111, projection='3d')#2d -> x,y = 1,1, 3d -> x,y,x=1,1,1
ax3d.scatter(iris['sepal_length'], iris['sepal_width'], iris['petal_length'], c=iris['petal_width'], cmap='Pastel1')
ax3d.set_xlabel('Sepal Length')
ax3d.set_ylabel('Sepal Width')
ax3d.set_zlabel('Petaal Width')
plt.show()
